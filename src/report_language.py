...
_REPORT_LABELS: Dict[str, Dict[str, str]] = {
    "zh": {
        ...
        "previous_watch_heading": "上次观察点核对",
        "previous_watch_condition_label": "观察条件",
        "previous_watch_status_label": "兑现状态",
        "previous_watch_evidence_label": "核对依据",
        "previous_watch_impact_label": "对本次决策影响",
        "previous_watch_summary_label": "核对结论",
        "previous_watch_fulfilled": "已兑现",
        "previous_watch_not_fulfilled": "未兑现",
        "previous_watch_partially_fulfilled": "部分兑现",
        "previous_watch_stale": "已过期",
        "previous_watch_no_previous": "无上次分析观察点",
        ...
        "decision_context_heading": "决策上下文",
        "decision_path_label": "决策路径",
        "risk_downgrade_label": "风控下调",
        "risk_applied_label": "风控已触发",
        "degraded_synthesis_label": "降级合成",
        "aligned_agent_consensus_label": "多 Agent 一致",
        "mixed_signals_synthesized_label": "信号分歧综合",
        "limited_opinion_synthesis_label": "样本不足综合",
        "risk_downgrade_transition": "最终信号已由 {from} 下调至 {to}",
        "degraded_synthesis_warning": "本次分析存在数据降级或阶段异常，结论稳健性下降。",
        "strategy_layer_note": "多策略综合为策略层共识；最终决策已综合风险（约 30% 权重、高严重度信号封顶）与技术/资金面。",
    ...
    "en": {
        ...
        "previous_watch_heading": "Previous Watch Verification",
        "previous_watch_condition_label": "Condition",
        "previous_watch_status_label": "Status",
        "previous_watch_evidence_label": "Evidence",
        "previous_watch_impact_label": "Impact on Decision",
        "previous_watch_summary_label": "Verification Summary",
        "previous_watch_fulfilled": "Fulfilled",
        "previous_watch_not_fulfilled": "Not Fulfilled",
        "previous_watch_partially_fulfilled": "Partially Fulfilled",
        "previous_watch_stale": "Stale",
        "previous_watch_no_previous": "No previous watch points",
        ...
        "decision_context_heading": "Decision Context",
        "decision_path_label": "Decision Path",
        "risk_downgrade_label": "Risk Downgrade",
        "risk_applied_label": "Risk Applied",
        "degraded_synthesis_label": "Degraded Synthesis",
        "aligned_agent_consensus_label": "Aligned Agent Consensus",
        "mixed_signals_synthesized_label": "Mixed Signals Synthesized",
        "limited_opinion_synthesis_label": "Limited Opinion Synthesis",
        "risk_downgrade_transition": "Final signal downgraded from {from} to {to}",
        "degraded_synthesis_warning": "Some data was degraded or a stage anomaly occurred, reducing confidence in the conclusion.",
        "strategy_layer_note": "The strategy synthesis is a strategy-layer consensus; the final decision also factors in risk (≈30% weight, high-severity signals cap at hold) and technical/capital flow.",
    ...
    "ko": {
        ...
        "previous_watch_heading": "이전 관찰 포인트 검증",
        "previous_watch_condition_label": "조건",
        "previous_watch_status_label": "상태",
        "previous_watch_evidence_label": "근거",
        "previous_watch_impact_label": "결정에 미치는 영향",
        "previous_watch_summary_label": "검증 결론",
        "previous_watch_fulfilled": "이행됨",
        "previous_watch_not_fulfilled": "미이행",
        "previous_watch_partially_fulfilled": "부분 이행",
        "previous_watch_stale": "만료",
        "previous_watch_no_previous": "이전 관찰 포인트 없음",
        ...
        "decision_context_heading": "의사결정 컨텍스트",
        "decision_path_label": "결정 경로",
        "risk_downgrade_label": "리스크 하향",
        "risk_applied_label": "리스크 적용됨",
        "degraded_synthesis_label": "저하된 종합",
        "aligned_agent_consensus_label": "다중 에이전트 일치",
        "mixed_signals_synthesized_label": "신호 분기 종합",
        "limited_opinion_synthesis_label": "표본 부족 종합",
        "risk_downgrade_transition": "최종 신호가 {from}에서 {to}로 하향 조정되었습니다",
        "degraded_synthesis_warning": "일부 데이터가 저하되거나 단계 이상이 발생해 결론 신뢰도가 낮아졌습니다.",
        "strategy_layer_note": "전략 종합은 전략 레이어의 합의이며, 최종 결정에는 리스크(약 30% 가중치, 고심각도 신호는 hold로 캡)와 기술/자금 흐름도 반영됩니다.",
