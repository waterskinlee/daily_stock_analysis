...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "AGENT_TECHNICAL_MODEL": {
        "title": "Technical Agent Model",
        "description": "Optional model override for the technical agent. Empty inherits AGENT_LITELLM_MODEL then LITELLM_MODEL.",
        "category": "ai_model",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        ...
        "validation": {},
        "display_order": 3,
        "help_key": "settings.ai_model.AGENT_TECHNICAL_MODEL",
        "examples": [
            "AGENT_TECHNICAL_MODEL=deepseek/deepseek-v4-pro",
        ],
        "docs": [],
        "warning_codes": ["inherits_primary_when_empty"],
    },
    "AGENT_INTEL_MODEL": {
        "title": "Intel Agent Model",
        "description": "Optional model override for the intelligence agent. Empty inherits AGENT_LITELLM_MODEL then LITELLM_MODEL.",
        "category": "ai_model",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        ...
        "validation": {},
        "display_order": 4,
        "help_key": "settings.ai_model.AGENT_INTEL_MODEL",
        "examples": [
            "AGENT_INTEL_MODEL=openai/gpt-5.6-sol",
        ],
        "docs": [],
        "warning_codes": ["inherits_primary_when_empty"],
    },
    "AGENT_RISK_MODEL": {
        "title": "Risk Agent Model",
        "description": "Optional model override for the risk agent. Empty inherits AGENT_LITELLM_MODEL then LITELLM_MODEL.",
        "category": "ai_model",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        ...
        "validation": {},
        "display_order": 5,
        "help_key": "settings.ai_model.AGENT_RISK_MODEL",
        "examples": [
            "AGENT_RISK_MODEL=openai/gpt-5.6-sol",
        ],
        "docs": [],
        "warning_codes": ["inherits_primary_when_empty"],
    },
    "AGENT_DECISION_MODEL": {
        "title": "Decision Agent Model",
        "description": "Optional model override for the decision agent. Empty inherits AGENT_LITELLM_MODEL then LITELLM_MODEL.",
        "category": "ai_model",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        ...
        "validation": {},
        "display_order": 6,
        "help_key": "settings.ai_model.AGENT_DECISION_MODEL",
        "examples": [
    ...
    "AGENT_SKILL_MODEL": {
        "title": "Skill Agent Model",
        "description": "Optional model override for skill/strategy agents. Empty inherits AGENT_LITELLM_MODEL then LITELLM_MODEL.",
        "category": "ai_model",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        ...
        "validation": {},
        "display_order": 7,
        "help_key": "settings.ai_model.AGENT_SKILL_MODEL",
        "examples": [
            "AGENT_SKILL_MODEL=openai/gpt-5.6-sol",
        ],
        "docs": [],
        "warning_codes": ["inherits_primary_when_empty"],
    },
    "AGENT_PORTFOLIO_MODEL": {
        "title": "Portfolio Agent Model",
        "description": "Optional model override for the portfolio agent. Empty inherits AGENT_LITELLM_MODEL then LITELLM_MODEL.",
        "category": "ai_model",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        ...
        "validation": {},
        "display_order": 8,
        "help_key": "settings.ai_model.AGENT_PORTFOLIO_MODEL",
        "examples": [
            "AGENT_PORTFOLIO_MODEL=openai/gpt-5.6-sol",
        ],
        "docs": [],
        "warning_codes": ["inherits_primary_when_empty"],
    },
    "AGENT_REPAIR_MODEL": {
        "title": "Repair Agent Model",
        "description": "Optional model override for the report integrity repair step. Empty inherits AGENT_LITELLM_MODEL then LITELLM_MODEL.",
        "category": "ai_model",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        ...
        "validation": {},
        "display_order": 9,
        "help_key": "settings.ai_model.AGENT_REPAIR_MODEL",
        "examples": [
            "AGENT_REPAIR_MODEL=openai/gpt-5.6-sol",
        ],
        "docs": [],
        "warning_codes": ["inherits_primary_when_empty"],
    },
    ...
    "AGENT_DAG_PARALLEL": {
        "title": "Parallel Independent Agent Stages",
        "description": "Run independent specialist stages (technical + intel) concurrently instead of sequentially.",
        "category": "agent",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
        ...
        "validation": {},
        "display_order": 65,
        "help_key": "settings.agent.AGENT_DAG_PARALLEL",
        "examples": [
            "AGENT_DAG_PARALLEL=true",
            "AGENT_DAG_PARALLEL=false",
        ],
        "docs": [],
        "warning_codes": [],
    },
